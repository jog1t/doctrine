...
- Per-agent doctrine versioning: each agent carries `deployedDoctrineVersion`; old agents use `previousDoctrine`; debrief shows version skew with orange indicator dot in MapView and "VERSION SKEW" warning in debrief
